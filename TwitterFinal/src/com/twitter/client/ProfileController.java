...
public class ProfileController {
    ...
    public void initialize() {
        /*nameOfAccount.setText("" + findAccount(Client.username).getFirstName() + "  " + findAccount(Client.username).getFirstName());
        bioOfAccount.setText(findAccount(Client.username).getBio());
        usernameOfAccount.setText(Client.username);
        StringBuilder stringBuilder = new StringBuilder();
        ArrayList<Tweet> tweets = new TimelineServiceImpl().showMyTweets(findAccount(Client.username));
